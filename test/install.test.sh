...
SKILL_ENTRIES=(
  ...
  "social-media:social-media/manage"
...
actual_skill_count=$(find "$REPO_ROOT/google-ads" "$REPO_ROOT/meta-ads" "$REPO_ROOT/seo" "$REPO_ROOT/social-media" "$REPO_ROOT/toprank-upgrade-skill" "$REPO_ROOT/gemini" -name "SKILL.md" | wc -l | tr -d ' ')
